...
# Values are ids (UUID / lich-controlled), no JSON escaping needed — same trust
# model as report-state.sh.
body="{\"session_id\":\"${LICH_SESSION_ID}\",\"provider_session_id\":\"${provider_session_id}\"}"
